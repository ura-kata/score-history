...
namespace ScoreHistoryApi.Logics.Scores
{
    public class ScorePageAdder
    {
        ...
        public ScorePageAdder(IAmazonDynamoDB dynamoDbClient, IScoreQuota scoreQuota, IConfiguration configuration)
        {
        ...
        public async Task AddPages(Guid ownerId, Guid scoreId, List<NewScorePage> pages)
        {
            ...
            await AddPagesAsync(ownerId, scoreId, trimmedPages);
        }
